...
The software package was originally written in Python 2.7 programming language, but has since been converted to Python 3 (see folder containing scripts converted to python 3). Thus it is fully compatible with the Linux and Windows (7, 8, 10) operating systems. Although it has not been tested, the software should also run properly on the Mac OS.
